...
```{r echo=FALSE}
raw_validate <- system.file(package = "antaDraft", "raw_validate.yml")
...
```{r echo=FALSE}
cty_rules <- system.file(package = "antaDraft", "cty_rules.yaml")
...
```{r echo=FALSE}
raw_validate <- system.file(package = "antaDraft", "agg_validate.yml")
raw_validate <- paste0(readLines(raw_validate), collapse = "\n" )
htmltools::tags$pre(raw_validate)
```
